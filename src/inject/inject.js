...
const semanticLabels = {
  development: {
    text: "development",
    comment: "Нужно внести изменения в код",
    icon: exclamationIcon,
    blocking: false,
  },
  review: {
...
const mrButtonClickHandler = (e, { textarea, label, blocking }) => {
  ...
  //Object.values(semanticLabels).map(e => e.text).filter(e => e !== text);
  let unlabels = '';
...
setInterval(function () {
  document
    .querySelectorAll(
      "div.merge-request #note-body:not([data-semantic-button-initialized])"
    )
